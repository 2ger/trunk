					...
					<div class="block email gong">
						<div class="main">
							<div class="div_title no_select">
								发起任务(公体)
                                <span>
 								   <?php if(($position_id) == "16"): ?><a href="<?php echo U('task/add?type=6');?>" class="btn btn-info btn-xs"> <i class="fa fa-plus"></i>公体教学进度</a>
 								  	 <a href="<?php echo U('task/add?type=2062');?>" class="btn btn-info btn-xs"> <i class="fa fa-plus"></i>综合类教学进度</a><?php endif; ?>
								</span>
							</div>
				           <div title="任务流程开始" class="taskflow">
								    <div class="col-sm-12">

									    <a  class="btn btn-lg  btn-success" >公体课</a>:
											<?php switch($isfa): case "1": ?><a href="<?php echo U('task/read');?>?id=<?php echo ($taskId); ?>" class="btn <?php echo ($btn1); ?>">教研室主任</a><?php break;?>
										   <?php default: ?>
										   <?php if(($position_id) == "16"): ?><a href="<?php echo U('task/add?type=6');?>" class="btn <?php echo ($btn1); ?>">教研室主任</a>
										   <?php else: ?>
	  								  ...
	  								  分管院长</a>
													   				           ...
													   				           <div title="任务流程开始" class="taskflow">
													   								    <div class="col-sm-12">
													   									    ...
													   									    <a  class="btn btn-lg  btn-success" >综合类</a>:
													   											<?php switch($isfa202): case "1": ?><a href="<?php echo U('task/read');?>?id=<?php echo ($taskId202); ?>" class="btn <?php echo ($btn2201); ?>">教研室主任</a><?php break;?>
													   										   <?php default: ?>
													   										   <?php if(($position_id) == "16"): ?><a href="<?php echo U('task/add?type=2062');?>" class="btn <?php echo ($btn2201); ?>">教研室主任</a>
													   										   <?php else: ?>
													   										  	 <a onclick="alert('权限不足')" class="btn ">教研室主任</a><?php endif; endswitch;?>
													   										 <i class="fa fa-arrow-right"></i>
		   			...
		   			<div class="block email zhuan">
		   						<div class="main">
		   							<div class="div_title no_select">
		   								发起任务(专业)
		                                   <span>
		    								   <?php if(($position_id) == "16"): ?><a href="<?php echo U('task/add?type=206');?>" class="btn btn-info btn-xs"> <i class="fa fa-plus"></i>专业教学进度</a><?php endif; ?>
		   								</span>
		   							</div>
		   				           ...
		   				           <div title="任务流程开始" class="taskflow">
		   								    <div class="col-sm-12">
		   									    ...
		   									    <a  class="btn btn-lg  btn-success" >提交教学进度</a>:
		   											<?php switch($isfa20): case "1": ?><a href="<?php echo U('task/read');?>?id=<?php echo ($taskId20); ?>" class="btn <?php echo ($btn201); ?>">教研室主任</a><?php break;?>
		   										   <?php default: ?>
		   										   <?php if(($position_id) == "16"): ?><a href="<?php echo U('task/add?type=206');?>" class="btn <?php echo ($btn201); ?>">教研室主任</a>
		   										   <?php else: ?>
		   										  	 <a onclick="alert('权限不足')" class="btn ">教研室主任</a><?php endif; endswitch;?>
		   										 <i class="fa fa-arrow-right"></i>
