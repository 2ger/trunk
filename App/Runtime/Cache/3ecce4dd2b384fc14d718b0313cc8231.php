...
><?php echo ($vo["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?></td>
			 ...
			 title=""><font color="#000000"><?php echo ($vo["name"]); ?></font></a>&nbsp;<?php echo (date('Y-m-d',$vo["create_time"])); ?>
											...
											<div class="already switch_" style="left: 856px; opacity: 0;">
												<ul>
													<?php if(is_array($jieshou)): $i = 0; $__LIST__ = $jieshou;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>【<?php echo ($vo["user_name"]); ?>】<a href="<?php echo U('task/read');?>?id=<?php echo ($vo["id"]); ?>"
			 title=""><font color="#000000"><?php echo ($vo["name"]); ?></font></a>&nbsp;<?php echo (date('Y-m-d',$vo["create_time"])); ?>
													</li><?php endforeach; endif; else: echo "" ;endif; ?>
												</ul>
											</div>
			            ...
			            <div class="block work" id="switchdiv2" style="overflow: hidden; z-index: 3;">
									<div class="main">
										...
										<div class="worklist">
											<div class="wait switch_">
												<ul>
			                                    <?php if(is_array($faqi)): $i = 0; $__LIST__ = $faqi;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>【<?php echo ($vo["user_name"]); ?>】<a href="<?php echo U('flow/read');?>?id=<?php echo ($vo["id"]); ?>"><font color="#000000"><?php echo ($vo["name"]); ?></font></a>&nbsp;<?php echo (date('Y-m-d',$vo["create_time"])); ?>
													</li><?php endforeach; endif; else: echo "" ;endif; ?>
												</ul>
											</div>
											<div class="already switch_" style="left: 856px; opacity: 0;">
												<ul>
													<?php if(is_array($shenpi)): $i = 0; $__LIST__ = $shenpi;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>【<?php echo ($vo["user_name"]); ?>】<a href="<?php echo U('flow/read');?>?id=<?php echo ($vo["id"]); ?>"><font color="#000000"><?php echo ($vo["name"]); ?></font></a>&nbsp;<?php echo (date('Y-m-d',$vo["create_time"])); ?>
													</li><?php endforeach; endif; else: echo "" ;endif; ?>
												</ul>
											</div>
										</div>
