...
<div id="content" style="height:750px">
			...
			<div class="block meeting" style="    min-height: 172px;">
            	<div class="main">
                	<div class="div_title no_select">召开会议(有考勤)
                    	<span>
			...
			<div class="block meeting" style="    min-height: 172px;">
            	<div class="main">
                	<div class="div_title no_select">召开会议(无考勤)
                    	<span>
                   			<!-- <select onChange="calenda.change()" id="calenda1">
                            </select> -->
                        </span>
            ...
            <div class="block email">
            	<div class="main">
                	<div class="div_title no_select">未召开会议 </div>
                	<ul>
                    	<?php if(is_array($task)): $i = 0; $__LIST__ = $task;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<?php echo ($vo["user_name"]); ?> <a href="<?php echo U('task/read');?>?id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?> (<?php echo (date('Y-m-d',$vo["create_time"])); ?>)</a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
            </div> <!-- end block -->
            <div class="block email">
            	<div class="main">
                	<div class="div_title no_select">已召开会议 </div>
                	<ul>
                    	<?php if(is_array($task_done)): $i = 0; $__LIST__ = $task_done;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<?php echo ($vo["user_name"]); ?> <a href="<?php echo U('task/read');?>?id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?> (<?php echo (date('Y-m-d',$vo["create_time"])); ?>)</a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
            </div> <!-- end block -->
