...
<div id="content" style="height:750px">
				...
				<div class="blocks" style="left:0;  width: 100%;">
					<div class="block email gong">
						<div class="main">
							<div class="div_title no_select">
								发起任务(公体)
								<span>
 								   <?php if(($position_id) == "16"): ?><a href="<?php echo U('task/add?type=5&pid=1');?>" class="btn btn-info btn-xs"> <i class="fa fa-plus"></i> 新公体课大纲任务</a>
									 <a href="<?php echo U('task/add?type=2052');?>" class="btn btn-info btn-xs"><i class="fa fa-plus"></i> 新综合类大纲任务</a><?php endif; ?>
								</span>
							</div>
								    ...
								    <div class="col-sm-12">
									    ...
									    <a  class="btn btn-lg  btn-success" >公体课大纲</a>:
															<?php switch($isfa): case "1": ?><a href="<?php echo U('task/read');?>?id=<?php echo ($taskId); ?>" class="btn <?php echo ($btn1); ?>">教研室主任</a><?php break;?>
										   <?php default: ?>
										   <?php if(($position_id) == "16"): ?><a href="<?php echo U('task/add?type=5');?>" class="btn <?php echo ($btn1); ?>">教研室主任</a>
										   <?php else: ?>
										  	 <a onclick="alert('权限不足')" class="btn ">教研室主任</a><?php endif; endswitch;?>
										 <i class="fa fa-arrow-right"></i>
										 
								 	<?php if(($lc) == "1"): ?><a href="<?php echo U('task/read');?>?id=<?php echo ($taskId); ?>" class="btn <?php echo ($btn2); ?>">
										<?php else: ?>
										<a href="<?php echo U('task/read');?>?id=<?php echo ($taskId); ?>" class="btn <?php echo ($btn2); ?>"><?php endif; ?>
	  								  老师提交</a>
									  <i class="fa fa-arrow-right"></i>
									  	<?php if(($zr) == "1"): ?><a href="<?php echo U('task/read');?>?id=<?php echo ($taskId); ?>" class="btn <?php echo ($btn3); ?>">
										<?php else: ?>
										<a href="<?php echo U('task/read');?>?id=<?php echo ($taskId); ?>" class="btn <?php echo ($btn3); ?>"><?php endif; ?>
	  								  教研室主任审核</a>
										<i class="fa fa-arrow-right"></i>
									<?php if(($js) == "1"): ?><a href="<?php echo U('task/read');?>?id=<?php echo ($taskId); ?>" class="btn <?php echo ($btn4); ?>">
										<?php else: ?>
											<a href="<?php echo U('task/read');?>?id=<?php echo ($taskId); ?>" class="btn <?php echo ($btn4); ?>"><?php endif; ?>
	  								  分管院长</a>
								    </div>
								</div><!-- #任务流程结束 -->    
											     ...
											     <div title="任务流程开始" class="taskflow">
															    <div class="col-sm-12">
																    <a  class="btn btn-lg  btn-success" >综合类大纲</a>:
																	<?php switch($isfa202): case "1": ?><a href="<?php echo U('task/read');?>?id=<?php echo ($taskId202); ?>" class="btn <?php echo ($btn2201); ?>">教研室主任</a><?php break;?>
																	   <?php default: ?>
																	   <?php if(($position_id) == "16"): ?><a href="<?php echo U('task/add?type=2052');?>" class="btn <?php echo ($btn2201); ?>">教研室主任</a>
																	   <?php else: ?>
																	  	 <a onclick="alert('权限不足')" class="btn ">教研室主任</a><?php endif; endswitch;?>
																	 <i class="fa fa-arrow-right"></i>
									 
															 	<?php if(($lc202) == "1"): ?><a href="<?php echo U('task/read');?>?id=<?php echo ($taskId202); ?>" class="btn <?php echo ($btn2202); ?>">
																	<?php else: ?>
																	<a href="<?php echo U('task/read');?>?id=<?php echo ($taskId202); ?>" class="btn <?php echo ($btn2202); ?>"><?php endif; ?>
								  								  老师提交</a>
								<i class="fa fa-arrow-right"></i>
																  	<?php if(($zr202) == "1"): ?><a href="<?php echo U('task/read');?>?id=<?php echo ($taskId202); ?>" class="btn <?php echo ($btn2203); ?>">
																	<?php else: ?>
																	<a href="<?php echo U('task/read');?>?id=<?php echo ($taskId202); ?>" class="btn <?php echo ($btn2203); ?>"><?php endif; ?>
								  								  教研室主任审核</a>
																	<i class="fa fa-arrow-right"></i>
																	<?php if(($js202) == "1"): ?><a href="<?php echo U('task/read');?>?id=<?php echo ($taskId202); ?>" class="btn <?php echo ($btn2204); ?>">
																	<?php else: ?>
																		<a href="<?php echo U('task/read');?>?id=<?php echo ($taskId202); ?>" class="btn <?php echo ($btn2204); ?>"><?php endif; ?>
								  								  分管院长</a>
															    </div>
															</div><!-- #任务流程结束 -->
			...
			<div class="block email zhuan">
						<div class="main">
							<div class="div_title no_select">
								发起任务(专业)
                                <span>
 								   <?php if(($position_id) == "16"): ?><a href="<?php echo U('task/add?type=205');?>" class="btn btn-info btn-xs"><i class="fa fa-plus"></i> 新综合类大纲任务</a><?php endif; ?>
								</span>
							</div>
				     <div title="任务流程开始" class="taskflow">
								    <div class="col-sm-12">
									    <a  class="btn btn-lg  btn-success" >专业课大纲</a>:
										<?php switch($isfa20): case "1": ?><a href="<?php echo U('task/read');?>?id=<?php echo ($taskId20); ?>" class="btn <?php echo ($btn201); ?>">教研室主任</a><?php break;?>
										   <?php default: ?>
										   <?php if(($position_id) == "16"): ?><a href="<?php echo U('task/add?type=205');?>" class="btn <?php echo ($btn201); ?>">教研室主任</a>
										   <?php else: ?>
										  	 <a onclick="alert('权限不足')" class="btn ">教研室主任</a><?php endif; endswitch;?>
										 <i class="fa fa-arrow-right"></i>
										 
								 	<?php if(($lc20) == "1"): ?><a href="<?php echo U('task/read');?>?id=<?php echo ($taskId20); ?>" class="btn <?php echo ($btn202); ?>">
										<?php else: ?>
										<a href="<?php echo U('task/read');?>?id=<?php echo ($taskId20); ?>" class="btn <?php echo ($btn202); ?>"><?php endif; ?>
	  								  老师提交</a>
	<i class="fa fa-arrow-right"></i>
									  	<?php if(($zr20) == "1"): ?><a href="<?php echo U('task/read');?>?id=<?php echo ($taskId20); ?>" class="btn <?php echo ($btn203); ?>">
										<?php else: ?>
										<a href="<?php echo U('task/read');?>?id=<?php echo ($taskId20); ?>" class="btn <?php echo ($btn203); ?>"><?php endif; ?>
	  								  教研室主任审核</a>
										<i class="fa fa-arrow-right"></i>
										<?php if(($js20) == "1"): ?><a href="<?php echo U('task/read');?>?id=<?php echo ($taskId20); ?>" class="btn <?php echo ($btn204); ?>">
										<?php else: ?>
											<a href="<?php echo U('task/read');?>?id=<?php echo ($taskId20); ?>" class="btn <?php echo ($btn204); ?>"><?php endif; ?>
	  								  分管院长</a>
								    </div>
								</div><!-- #任务流程结束 -->         
				...
				<div class="block work gong" id="switchdiv1" style="overflow: hidden; z-index: 3;">
						<div class="main">
							...
							<div class="worklist">
								<div class="wait switch_" style="z-index: 2; left: 0px; opacity: 1;">
									<ul>
										<?php echo ($todo); ?> 
									</ul>
								</div>
								<div class="already switch_" style="left: 771px; opacity: 0; z-index: 1;">
									<ul>
										<?php echo ($doing); ?> 
									</ul>
								</div>

								<div class="already switch_" style="left: 1000px; opacity: 0; z-index: 1;">
									<ul>
										<?php echo ($done); ?> 
									</ul>
								</div>
				...
				<div class="block work zhuan" id="switchdiv2" style="overflow: hidden; z-index: 3;">
						<div class="main">
							<div class="div_title1 no_select">
								<div class="switch_btn divBG2 divBG1">
									待办
