...
<div id="content" style="height:750px">
			...
			<div class="block meeting">
            	<div class="main">
                	<div class="div_title no_select">发起任务
                    	<span>
				 ...
				 <table class="pure-table pure-table-bordered" style="width: 90%;margin: 30px 20px;">
				    	 		<div title="任务流程开始" class="taskflow">
							 	   <div class="col-sm-12">
									    <a  class="btn btn-lg  btn-success">AB式</a> :
										
										 <a href="<?php echo U('task/add?type=104');?>" class="btn btn-danger ">A(发起人)</a>
										 <i class="fa fa-arrow-right"></i>
										 
										 <a href="#" class="btn  btn-default">B</a> 
								    </div>
								</div><!-- #任务流程结束 -->	
				    	 		<div title="任务流程开始" class="taskflow">
							 	   <div class="col-sm-12">
									    <a  class="btn btn-lg  btn-success">ABA式</a> :
										
										 <a href="<?php echo U('task/add?type=105');?>" class="btn btn-danger ">A(发起人)</a>
										 <i class="fa fa-arrow-right"></i>
										 
										 <a href="#" class="btn  btn-default">B</a> <i class="fa fa-arrow-right"></i>
										  <a href="#" class="btn  btn-default">A</a>
								    </div>
								</div><!-- #任务流程结束 -->	
				    	 		<div title="任务流程开始" class="taskflow">
							 	   <div class="col-sm-12">
									    <a  class="btn btn-lg  btn-success">ABC式</a> :
										
										 <a href="<?php echo U('task/add?type=106');?>" class="btn btn-danger ">A(发起人)</a>
										 <i class="fa fa-arrow-right"></i>
										 
										 <a href="#" class="btn  btn-default">B</a> <i class="fa fa-arrow-right"></i>
										  <a href="#" class="btn  btn-default">C</a>
								    </div>
								</div><!-- #任务流程结束 -->						
								...
								<div title="任务流程开始" class="taskflow">
								    <div class="col-sm-12">
									    ...
									    <a  class="btn btn-lg  btn-success">ABAB式</a> :
										
										 <a href="<?php echo U('task/add?type=107');?>" class="btn btn-danger ">A(发起人)</a><i class="fa fa-arrow-right"></i>
										 <a href="#" class="btn  btn-default">B</a> <i class="fa fa-arrow-right"></i>
										  <a href="#" class="btn  btn-default">A</a><i class="fa fa-arrow-right"></i>
										  <a href="#" class="btn  btn-default">B</a>
								    </div>
								</div><!-- #任务流程结束 -->
								</table>
            ...
            <div class="block email">
            	<div class="main">
                	<div class="div_title no_select">任务记录<!-- <a style="margin-left:200px;" href="/__APP__/index.php/flow/add/type/39">提交申报</a> --></div>
                	<ul>
                    	<?php if(is_array($task)): $i = 0; $__LIST__ = $task;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>【<?php echo ($vo["user_name"]); ?>】<a href="<?php echo U('task/read');?>?id=<?php echo ($vo["id"]); ?>" title=""><font color="#000000"><?php echo ($vo["name"]); ?></font></a>&nbsp;(<?php echo (date('Y-m-d',$vo["create_time"])); ?>)
