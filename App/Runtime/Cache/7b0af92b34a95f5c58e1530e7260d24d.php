				...
				<div class="blocks" style="left:0;  width: 100%;">
					<div class="block email gong">
						<div class="main">
							<div class="div_title no_select">
								我的教案（公体）
									<span><a href="<?php echo U('flow/add');?>?type=68" class="btn btn-sm btn-info">提交新教案</a> 
										 <a href="<?php echo U('flow/add');?>?type=68&jiaoan=zhonghe" class="btn btn-sm btn-info">提交新综合类教案</a><!-- 请点击下面方格进行提交教案 --><!-- （绿：已审核、红：未审核、白：未提交） --></span>
							</div>
							
							<div title="任务流程开始" class="taskflow">
							    <div class="col-sm-12">
								    <a  class="btn btn-lg  btn-success" >公体教案</a> :
								 <?php if(($isfa) == "1"): ?><a href="<?php echo U('flow/read');?>?id=<?php echo ($flowId); ?>" class="btn <?php echo ($btn21); ?>">提交本学期教案</a> 
  									<?php else: ?>
									 	<a href="<?php echo U('flow/add');?>?type=68" class="btn <?php echo ($btn21); ?>">提交本学期教案</a><?php endif; ?>
									 <i class="fa fa-arrow-right"></i>
								<?php if(($iswan) == "1"): ?><a href="<?php echo U('flow/read');?>?id=<?php echo ($flowId); ?>" class="btn <?php echo ($btn22); ?>">
									<?php else: ?>
									<a href="<?php echo U('flow/read');?>?id=<?php echo ($flowId); ?>" class="btn <?php echo ($btn22); ?>"><?php endif; ?>
  								  审核</a>
							...
							<div title="任务流程开始" class="taskflow">
							    <div class="col-sm-12">
								    <a  class="btn btn-lg  btn-success" >综合类教案</a> :
								 <?php if(($isfa22) == "1"): ?><a href="<?php echo U('flow/read');?>?id=<?php echo ($flowId22); ?>" class="btn <?php echo ($btn2212); ?>">提交本学期教案</a> 
  									<?php else: ?>
								 	<a href="<?php echo U('flow/add');?>?type=68&jiaoan=100" class="btn <?php echo ($btn2212); ?>">提交本学期教案</a><?php endif; ?>
									 <i class="fa fa-arrow-right"></i>
								<?php if(($iswan22) == "1"): ?><a href="<?php echo U('flow/read');?>?id=<?php echo ($flowId22); ?>" class="btn <?php echo ($btn2222); ?>">
									<?php else: ?>
									<a href="<?php echo U('flow/read');?>?id=<?php echo ($flowId22); ?>" class="btn <?php echo ($btn2222); ?>"><?php endif; ?>
  								  审核</a>
					...
					<div class="block email zhuan">
						<div class="main">
							<div class="div_title no_select">
								我的教案(专业)
									<span><a href="<?php echo U('flow/add');?>?type=85" class="btn btn-sm btn-info">提交新教案</a> <!-- 请点击下面方格进行提交教案 --><!-- （绿：已审核、红：未审核、白：未提交） --></span>
								</div>
								
								<div title="任务流程开始" class="taskflow">
								    <div class="col-sm-12">
									    <a  class="btn btn-lg  btn-success" >专业教案</a> :
									 <?php if(($isfa2) == "1"): ?><a href="<?php echo U('flow/read');?>?id=<?php echo ($flowId2); ?>" class="btn <?php echo ($btn212); ?>">提交本学期教案</a> 
	  									<?php else: ?>
										 	<a href="<?php echo U('flow/add');?>?type=85" class="btn <?php echo ($btn212); ?>">提交全年教案</a><?php endif; ?>
										 <i class="fa fa-arrow-right"></i>
									<?php if(($iswan2) == "1"): ?><a href="<?php echo U('flow/read');?>?id=<?php echo ($flowId2); ?>" class="btn <?php echo ($btn222); ?>">
										<?php else: ?>
										<a href="<?php echo U('flow/read');?>?id=<?php echo ($flowId2); ?>" class="btn <?php echo ($btn222); ?>"><?php endif; ?>
	  								  审核</a>
