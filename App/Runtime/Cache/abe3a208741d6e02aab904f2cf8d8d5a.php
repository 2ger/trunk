...
<input type="hidden" name="ajax" id="ajax" value="1">
	...
	<div class="operate panel panel-default  <?php echo ($hidden); ?>">
		...
		<form id="form_data" name="form_data" method="post" class="form-horizontal">
			...
			<table class="table table-bordered" >
				<tr>
					...
					<td rowspan="4"> <!-- <img class="img-thumbnail col-12" id="emp_pic" src="" > --></td>
				</tr>
				<tr>
					<th>姓名*</th>
					<td colspan="2">
				...
				<tr>
					...
					<td colspan="2">
						<!-- <a onclick="select_avatar();" class="btn btn-sm btn-primary">上传头像</a> -->
					</td>
				</tr>
				<tr>
					<th>职级*</th>
