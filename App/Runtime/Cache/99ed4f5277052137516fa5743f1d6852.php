...
<div id="content" style="height:750px">
			...
			<div class="block meeting">
            	<div class="main">
                	<div class="div_title no_select">任务及审批
                    	<span>
                   			<!-- <select onChange="calenda.change()" id="calenda1">
                            </select> -->
                        </span>
                    </div>
								...
								<div title="任务流程开始" class="taskflow">
								    <div class="col-sm-12">
									    <a  class="btn btn-lg  btn-success">通用任务</a> :
										 <a href="<?php echo U('task/add?type=chengguo');?>" class="btn  btn-danger">发起任务</a> <i class="fa fa-arrow-right"></i>
										  <a  class="btn  btn-default">执行人</a>
								    </div>
								</div><!-- #任务流程结束 -->
								
								<div title="任务流程开始" class="taskflow">
								    <div class="col-sm-12">
									    <a  class="btn btn-lg  btn-success">通用审批</a> :
										 <a href="<?php echo U('flow/add?type=96');?>" class="btn btn-danger ">发起请示</a>
										 <i class="fa fa-arrow-right"></i>
										  <a  class="btn  btn-default">审批人</a>
								    </div>
								</div><!-- #任务流程结束 -->
								
								<div title="任务流程开始" class="taskflow">
								    <div class="col-sm-12">
									    <a  class="btn btn-lg  btn-success">申报加分</a> :
										 <a href="<?php echo U('flow/add?type=44');?>" class="btn btn-danger ">填写申报</a>
										 <i class="fa fa-arrow-right"></i>
										  <a  class="btn  btn-default">教务秘书审批</a>
								    </div>
								</div><!-- #任务流程结束 -->
                </div>               
            </div>
            <div class="block email">
            	<div class="main">
                	<div class="div_title no_select">申报加分记录 <span><a style="margin-left:200px;" href="<?php echo U('flow/add?type=44');?>">提交申报</a></span></div>
                	<ul>
                    	<?php if(is_array($shenbao)): $i = 0; $__LIST__ = $shenbao;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<a href="<?php echo U('flow/read');?>?id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?> (<?php echo (date('Y-m-d',$vo["create_time"])); ?>)</a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                </div>
            </div> <!-- end block -->
            ...
            <div class="block email">
            	<div class="main">
                	<div class="div_title no_select">通用任务记录 </div>
                	<ul>
                    	<?php if(is_array($task)): $i = 0; $__LIST__ = $task;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<a href="<?php echo U('task/read');?>?id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?> (<?php echo (date('Y-m-d',$vo["create_time"])); ?>)</a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
            </div> <!-- end block -->
            <div class="block email">
            	<div class="main">
                	<div class="div_title no_select">通用审批记录 </div>
                	<ul>
                    	<?php if(is_array($flow)): $i = 0; $__LIST__ = $flow;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<a href="<?php echo U('flow/read');?>?id=<?php echo ($vo["id"]); ?>">【 <?php echo ($vo["name"]); ?> 】  <font color="#000000"><?php echo ($vo["confirm_name"]); ?></font> (<?php echo (date('Y-m-d',$vo["create_time"])); ?>)</a> </li><?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
            </div> <!-- end block -->
