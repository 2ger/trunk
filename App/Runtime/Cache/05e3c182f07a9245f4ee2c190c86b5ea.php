					...
					<div class="block email gong">
						<div class="main">
							<div class="div_title no_select">
								发起任务(公体)
                                <span>
 								   <?php if(($user_rank) == "22"): ?><a href="<?php echo U('task/add?type=9');?>" class="btn btn-info btn-xs"> <i class="fa fa-plus"></i>公体总结</a>

 								  	 <a href="<?php echo U('task/add?type=2092');?>" class="btn btn-info btn-xs"> <i class="fa fa-plus"></i>综合类总结</a><?php endif; ?>
								</span>
							</div>
								<table class="pure-table pure-table-bordered" style="width: 90%;margin: 30px 20px;">
								    ...
								    <div class="col-sm-12">
									    ...
									    <a  class="btn btn-lg  btn-success" >公体总结</a>:
											<?php switch($isfa): case "1": ?><a href="<?php echo U('task/read');?>?id=<?php echo ($taskId20); ?>" class="btn <?php echo ($btn1); ?>">教务秘书</a><?php break;?>
									   <?php default: ?>
										   <?php if(($user_rank) == "22"): ?><a href="<?php echo U('task/add?type=9');?>" class="btn <?php echo ($btn1); ?>">教务秘书</a>
										   <?php else: ?>
										  	 <a onclick="alert('权限不足')" class="btn ">教务秘书</a><?php endif; endswitch;?>
										 <i class="fa fa-arrow-right"></i>
										 
									 	<?php if(($lc) == "1"): ?><a href="<?php echo U('task/read');?>?id=<?php echo ($taskId20); ?>" class="btn <?php echo ($btn2); ?>">
										<?php else: ?>
										<a href="<?php echo U('task/read');?>?id=<?php echo ($taskId20); ?>" class="btn <?php echo ($btn2); ?>"><?php endif; ?>
	  								  老师</a>
	<i class="fa fa-arrow-right"></i>

									  	<?php if(($zr) == "1"): ?><a href="<?php echo U('task/read');?>?id=<?php echo ($taskId20); ?>" class="btn <?php echo ($btn3); ?>">
										<?php else: ?>
										<a href="<?php echo U('task/read');?>?id=<?php echo ($taskId20); ?>" class="btn <?php echo ($btn3); ?>"><?php endif; ?>
	  								  教研室主任</a>
										<i class="fa fa-arrow-right"></i>
										<?php if(($js) == "1"): ?><a href="<?php echo U('task/read');?>?id=<?php echo ($taskId20); ?>" class="btn <?php echo ($btn4); ?>">
										<?php else: ?>
											<a href="<?php echo U('task/read');?>?id=<?php echo ($taskId20); ?>" class="btn <?php echo ($btn4); ?>"><?php endif; ?>
	  								  教务秘书</a>
								    </div>
								</div><!-- #任务流程结束 -->       
			   														    ...
			   														    <div class="col-sm-12">
			   															    ...
			   															    <a  class="btn btn-lg  btn-success" >综合类总结</a>:
			   																	<?php switch($isfa202): case "1": ?><a href="<?php echo U('task/read');?>?id=<?php echo ($taskId202); ?>" class="btn <?php echo ($btn2201); ?>">教务秘书</a><?php break;?>
			   															   <?php default: ?>
			   																   <?php if(($user_rank) == "22"): ?><a href="<?php echo U('task/add?type=2092');?>" class="btn <?php echo ($btn2201); ?>">教务秘书</a>
			   																   <?php else: ?>
			   																  	 <a onclick="alert('权限不足')" class="btn ">教务秘书</a><?php endif; endswitch;?>
			   																 <i class="fa fa-arrow-right"></i>
									...
									<div class="block email zhuan">
										<div class="main">
											<div class="div_title no_select">
												发起任务(专业)
				                                <span>
				 								   <?php if(($user_rank) == "22"): ?><a href="<?php echo U('task/add?type=209');?>" class="btn btn-info btn-xs"> <i class="fa fa-plus"></i>专业总结</a><?php endif; ?>
												</span>
											</div>
												    ...
												    <div class="col-sm-12">
													    ...
													    <a  class="btn btn-lg  btn-success" >组织总结</a>:
															<?php switch($isfa20): case "1": ?><a href="<?php echo U('task/read');?>?id=<?php echo ($taskId20); ?>" class="btn <?php echo ($btn201); ?>">教务秘书</a><?php break;?>
													   <?php default: ?>
														   <?php if(($user_rank) == "22"): ?><a href="<?php echo U('task/add?type=209');?>" class="btn <?php echo ($btn201); ?>">教务秘书</a>
														   <?php else: ?>
														  	 <a onclick="alert('权限不足')" class="btn ">教务秘书</a><?php endif; endswitch;?>
														 <i class="fa fa-arrow-right"></i>
				...
				<div class="block work gong" id="switchdiv2" style="overflow: hidden; z-index: 3;">
				...
				<div class="block work zhuan" id="switchdiv1" style="overflow: hidden; z-index: 3;">
										<div class="main">
											<div class="div_title1 no_select">
												<div class="switch_btn divBG2 divBG1">
													待办
