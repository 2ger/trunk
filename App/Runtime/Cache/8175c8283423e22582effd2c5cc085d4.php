				...
				<div class="main">
					<div class="div_title no_select">
						...
						<div title="任务流程开始" class="taskflow">
								    <div class="col-sm-12">
									    <a  class="btn btn-lg  btn-success">审查学生资格</a> <i class="fa fa-angle-double-right
"></i>

<?php switch($step1): case "1": ?><a href="<?php echo U('flow/read');?>?id=<?php echo ($taskId); ?>" class="btn btn-success">教务秘书</a><?php break;?>
									   <?php default: ?>
										   <?php if(($position_id) == "24"): ?><a href="<?php echo U('flow/add?type=58');?>" class="btn btn-danger">教务秘书</a>
										   <?php else: ?>
...
<?php switch($step21): case "1": ?><a href="<?php echo U('flow/read');?>?id=<?php echo ($flowid2); ?>" class="btn btn-success">论文领导小组(苏龙)</a><?php break;?>
										 ...
										 <i class="fa fa-arrow-right"></i>
										 <?php switch($step22): case "0": ?><a href="<?php echo U('flow/read');?>?id=<?php echo ($flowid2); ?>" class="btn btn-danger">院长</a><?php break;?>
										     <?php case "1": ?><a href="<?php echo U('flow/read');?>?id=<?php echo ($flowid2); ?>" class="btn btn-success">院长</a><?php break;?>
										     <?php default: ?>	<a class="btn  btn-default"> 院长</a><?php endswitch;?>
								    </div>
								</div>
            ...
            <div class="block email">
            	<div class="main">
                	<div class="div_title no_select">工作记录</div>
                		<ul>
