...
<div id="content" style="height:750px">
								...
								<div title="任务流程开始" class="taskflow">
								    <div class="col-sm-12">
									    <a  class="btn btn-lg  btn-success">通用任务</a> :
										 <a href="<?php echo U('task/add?type=jianshe');?>" class="btn  btn-danger">发起任务</a> <i class="fa fa-arrow-right"></i>
								...
								<div title="任务流程开始" class="taskflow">
								    <div class="col-sm-12">
									    <a  class="btn btn-lg  btn-success">通用审批</a> :
										 <a href="<?php echo U('flow/add?type=99');?>" class="btn btn-danger ">发起请示</a>
								...
								<div title="任务流程开始" class="taskflow">
								    <div class="col-sm-12">
									    <a  class="btn btn-lg  btn-success">申报加分</a> :
										 <a href="<?php echo U('flow/add?type=47');?>" class="btn btn-danger ">填写申报</a>
										 <i class="fa fa-arrow-right"></i>
            ...
            <div class="block email">
            	<div class="main">
                	<div class="div_title no_select">申报加分记录 <span><a style="margin-left:200px;" href="<?php echo U('flow/add?type=47');?>">提交申报</a></span></div>
                	<ul>
